...
type TripServiceClient interface {
	...
	GetTrips(ctx context.Context, in *GetTripsRequest, opts ...grpc.CallOption) (*GetTripsResponses, error)
	UpdateTrip(ctx context.Context, in *UpdateTripRequest, opts ...grpc.CallOption) (*UpdateTripResponse, error)
	DelTrip(ctx context.Context, in *DelTripRequest, opts ...grpc.CallOption) (*DelTripResponse, error)
}
...
func (c *tripServiceClient) GetTrips(ctx context.Context, in *GetTripsRequest, opts ...grpc.CallOption) (*GetTripsResponses, error) {
	out := new(GetTripsResponses)
...
func (c *tripServiceClient) DelTrip(ctx context.Context, in *DelTripRequest, opts ...grpc.CallOption) (*DelTripResponse, error) {
	out := new(DelTripResponse)
	err := c.cc.Invoke(ctx, "/rental.v1.TripService/DelTrip", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TripServiceServer interface {
	...
	GetTrips(context.Context, *GetTripsRequest) (*GetTripsResponses, error)
	UpdateTrip(context.Context, *UpdateTripRequest) (*UpdateTripResponse, error)
	DelTrip(context.Context, *DelTripRequest) (*DelTripResponse, error)
...
func (UnimplementedTripServiceServer) GetTrips(context.Context, *GetTripsRequest) (*GetTripsResponses, error) {
...
func (UnimplementedTripServiceServer) DelTrip(context.Context, *DelTripRequest) (*DelTripResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DelTrip not implemented")
}
...
func _TripService_DelTrip_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DelTripRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TripServiceServer).DelTrip(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rental.v1.TripService/DelTrip",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TripServiceServer).DelTrip(ctx, req.(*DelTripRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TripService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DelTrip",
			Handler:    _TripService_DelTrip_Handler,
		},
	},
